...
# # Emotion tracking variables (now tracked in milliseconds)
# emotion_time_counters = {emotion: 0 for emotion in ('angry', 'disgust', 'fear', 'happy', 'sad', 'surprise', 'neutral')}
# start_time = time.time()
# capture_duration = 5  # Capture emotions for 10 seconds
...
#     # Check if the time is up (10 seconds have passed)
...
#         print(f"The most frequent emotion detected over 10 seconds is: {most_frequent_emotion}")

#         # Reset the start time and counters for the next 10-second window
#         start_time = time.time()
#         emotion_time_counters = {emotion: 0 for emotion in emotions}

#     # Capture image or quit application
